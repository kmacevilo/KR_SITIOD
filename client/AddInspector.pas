...
begin
    ...
    if (login = '') then
    begin
      Application.MessageBox('Не введен логин для пользователя!','Не успех',MB_OK + MB_ICONINFORMATION);
      Exit;
    end;
    pass:= EPass.text;
...
begin
  ...
  if (InputQuery('Выбор таможни',['Введите таможню для просмотра:'],superCustom))
